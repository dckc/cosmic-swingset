...
export function makeHTTPListener(basedir, port, host, inboundCommand, { createServer }) {
  const app = express();
  // HTTP logging.
  app.use(
    morgan(
